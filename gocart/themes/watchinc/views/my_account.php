...
?>
			...
			<div class="container">
						...
						<div class="col-sm-3">
							<div class="preview change-mode-box">
								<div>
									<div class="media">
										...
										<div class="media-body media-middle">
											<h4 class="media-heading"><?php echo $info->firstname ;?> <?php echo $info->lastname ;?></h4>
										</div>
									</div>
								</div>
								<br>
								<div>
									...
									<p><i><?php if(!(bool)$info->email_subscribe) { ?> You Are Not <?php } ?> Subscribed to Newsletter</i></p>
								</div>
								<br>
								<?php if ($addresses != NULL):?>
									...
									?>
										<div>
											<h4>Address <?php echo $c;?>
											<?php if($customer['default_shipping_address']==$a['id']) echo '<span>(Default Shipping)</span>'; ?></h4>
											<?php
												$b	= $a['field_data'];
							...
							<div class="edit change-mode-box">
								<form>
									<div>
										<div class="media">
											<div class="media-left media-middle">
											...
											<div class="media-body media-middle">
												<input type="text" class="form-control" placeholder="Name" value="<?php echo $info->firstname ;?> <?php echo $info->lastname ;?>">
											</div>
										</div>
									</div>
									<br>
									<div>
										<h4>Registered Email</h4>
										<input type="text" class="form-control" placeholder="Email" value="<?php echo $info->email ;?>">
										<div class="checkbox">
											<label>
												<input type="checkbox" <?php if((bool)$info->email_subscribe) { ?> checked="checked" <?php } ?>/> Subscribed to Newsletter
											</label>
										</div>
									</div>
									<br>
									<?php if ($addresses != NULL):?>
										...
										?>
											<div>
												<h4>Address <?php echo $c;?></h4>
												<textarea class="form-control" placeholder="Address 1" rows="4" style="resize: none;">
													<?php
														$b	= $a['field_data'];
														echo(format_address($b));
														$c++;
													?>
												</textarea>
												<div class="radio">
													<label>
														<input type="radio" name="default_address" value="address<?php echo $c;?>" <?php if($customer['default_shipping_address']==$a['id']) echo 'checked="checked"'; ?>>Set as Default Shipping Address
													</label>
												</div>
											</div>
											<br>
									...
									<?php else: ?>
										<h4>Address 1</h4>
										<textarea class="form-control" placeholder="Address 1" rows="4" style="resize: none;"></textarea>
										<div class="radio">
											<label>
												<input type="radio" name="default_address" value="address1">Set as Default Shipping Address
											</label>
										</div>
										<br>
									<?php endif;?>
									<div>
										<h4>Phone Number</h4>
										<input type="text" class="form-control" placeholder="Phone Number" value="<?php echo $info->phone ;?>">
									</div>
									<br>
				...
				<div>
					<input type="hidden" id="php-message-delete-address-confirmation" value="<?php echo lang('delete_address_confirmation');?>">
					<input type="hidden" id="php-message-error-must-have-address" value="<?php echo lang('error_must_have_address');?>">
					<input type="hidden" id="php-url-set-default-address" value="<?php echo site_url('secure/set_default_address');?>">
				</div>
