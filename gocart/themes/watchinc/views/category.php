						...
						<div class="head-temp">
							<div class="head-banner">
								...
								<?php elseif ($page_title=="Search"):?>
									<h4 class="title-watch"><span class="orange">SEARCH</span> PRODUCT - <span><?php echo $term;?></span></h4> 
								<?php else:?>
									<h4 class="title-watch"><span class="orange">PRODUCT</span> WATCHES  - <span><?php echo $category->seo_title;?></span></h4>
