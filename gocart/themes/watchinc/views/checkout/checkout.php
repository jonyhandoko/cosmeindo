								...
								<div class="col-sm-6">
									<div class="payment-box">
										...
										<form>
											...
											<p><img src="<?php echo base_url('/images/watchinc/method/bank-bca.png');?>" class="bank-img">BANK BCA JONY HANDOKO - 313131313</p>
											...
											<?php else: ?>
												...
												<div class="total">
													<div class="row">
														...
														<div class="col-xs-8">
															<p>SHIPPING (<span><?php echo $this->go_cart->shipping_method();?></span>)</p>
														</div>
														<div class="col-xs-4">
