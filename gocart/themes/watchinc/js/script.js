...
// My Account
	...
	$('.delete_address').click(function() {
		if ($('.delete_address').length > 1) {
			if (confirm(pmdac.value)) {
				$.post("http://localhost/watchinc/secure/delete_address", { id: $(this).attr('rel') }, function(data) {
	...
	function set_default(address_id, type) {
		...
		$.post('http://localhost/watchinc/secure/set_default_address/',{id:address_id, type:type}, function(data) {
